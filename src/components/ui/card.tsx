...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("app-card rounded-xl border border-border/40 bg-card/95 backdrop-blur-sm text-card-foreground shadow-lg transition-all duration-300", className)} {...props} />
));
